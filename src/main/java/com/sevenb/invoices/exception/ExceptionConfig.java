...
import com.sevenb.invoices.model.ApiError;
...
public class ExceptionConfig extends ResponseEntityExceptionHandler {
    ...
    @Override
    public ResponseEntity<Object> handleMethodArgumentNotValid(MethodArgumentNotValidException ex, HttpHeaders headers, org.springframework.http.HttpStatusCode status, WebRequest request) {
